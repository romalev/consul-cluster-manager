...
abstract class ConsulMap<K, V> {
    ...
    private final EnumSet<ClusterManagerMaps> clusterManagerMaps = EnumSet.of(ClusterManagerMaps.VERTX_HA_INFO, ClusterManagerMaps.VERTX_NODES, ClusterManagerMaps.VERTX_SUBS);
